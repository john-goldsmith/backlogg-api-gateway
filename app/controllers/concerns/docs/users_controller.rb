      ...
      module UsersController
        ...
        included do
          ...
          swagger_path '/users/{id}' do
            ...
            operation :put do
              ...
              parameter do
                key :name, :id
                key :in, :path
                key :description, 'ID of user to modify'
                key :required, true
                key :type, :integer
                key :format, :int64
              end
          ...
          swagger_path '/users/{id}/comments' do
            ...
            operation :get do
              key :summary, 'Get comments for a specific user'
              key :description, 'Get comments for a specific user'
              key :operationId, 'getCommentsForUser'
              key :tags, [
                'user'
              ]
              parameter do
